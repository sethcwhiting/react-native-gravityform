...
class HmrServer {
  ...
  onClientConnect(clientUrl, sendFn) {
    ...
    return _asyncToGenerator(function*() {
      ...
      yield _this._handleFileChange(client);
  ...
  _prepareMessage(client) {
    ...
    return _asyncToGenerator(function*() {
      try {
        ...
        const _hmrJSBundle = hmrJSBundle(delta, revision.graph, {
            createModuleId: _this3._createModuleId,
            projectRoot: _this3._config.projectRoot
          }),
          modules = _hmrJSBundle.modules,
          deleted = _hmrJSBundle.deleted,
          sourceMappingURLs = _hmrJSBundle.sourceMappingURLs,
          sourceURLs = _hmrJSBundle.sourceURLs;
