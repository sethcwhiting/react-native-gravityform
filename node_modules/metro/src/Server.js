...
class Server {
      ...
      this._createRequestProcessor({
        ...
        build: (function() {
          var _ref6 = _asyncToGenerator(function*(_ref7) {
            ...
            const possibleCustomSerializer =
              _this._config.serializer.customSerializer;

            if (possibleCustomSerializer) {
              bundle = possibleCustomSerializer.apply(
                void 0,
                serializerArguments
              );
            } else {
              const base = baseJSBundle.apply(void 0, serializerArguments);
      ...
      this._createRequestProcessor({
        ...
        build: (function() {
          var _ref14 = _asyncToGenerator(function*(_ref15) {
            ...
            const _ref16 = yield _this._bundler.buildGraph(
                entryFile,
                transformOptions,
                {
                  onProgress
  ...
  build(options) {
    ...
    return _asyncToGenerator(function*() {
      ...
      const _ref18 = yield _this2._bundler.buildGraph(
          entryFile,
          transformOptions,
          {
            onProgress
  ...
  getRamBundleInfo(options) {
    ...
    return _asyncToGenerator(function*() {
      ...
      const _ref19 = yield _this3._bundler.buildGraph(
          entryFile,
          transformOptions,
          {
            onProgress
  ...
  getAssets(options) {
    ...
    return _asyncToGenerator(function*() {
      ...
      const _ref20 = yield _this4._bundler.buildGraph(
          entryFile,
          transformOptions,
          {
            onProgress
  ...
  getOrderedDependencyPaths(options) {
    ...
    return _asyncToGenerator(function*() {
      ...
      const _ref21 = yield _this5._bundler.buildGraph(
          entryFile,
          transformOptions,
          {
            onProgress
  ...
  _createRequestProcessor(_ref22) {
    ...
    return (
      ...
      (function() {
        ...
        return function requestProcessor(_x5, _x6) {
  ...
  _sourceMapForURL(reqUrl) {
    ...
    return _asyncToGenerator(function*() {
      ...
      if (revPromise == null) {
        var _ref23 = yield _this8._bundler.initializeGraph(
